...
function LoginCard() {
  ...
  return (
    <div className="bg-gray h-screen flex justify-center items-center">
      <div className="w-[60rem] max-h-[30rem] flex justify-between items-center bg-white rounded-md shadow-md px-4 py-5">
        <div className="background-img h-full w-full">
          <LoginImg />
        </div>
        <div className="w-full h-[30rem] flex flex-col justify-around p-8">
          <div className="">
            <h4 className="font-bold text-32 text-center py-2">Login</h4>
          </div>
          <div className="capitalize flex justify-around w-full items-center text-16 font-semibold">
            <div
